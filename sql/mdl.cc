...
MDL_lock::MDL_backup_lock::m_granted_incompatible[MDL_BACKUP_END]=
{
  ...
  /* MDL_BACKUP_DML */
  MDL_BIT(MDL_BACKUP_STAGE1) | MDL_BIT(MDL_BACKUP_STAGE2) | MDL_BIT(MDL_BACKUP_STAGE3) | MDL_BIT(MDL_BACKUP_STAGE4) | MDL_BIT(MDL_BACKUP_FTWRL1) | MDL_BIT(MDL_BACKUP_FTWRL2),
  ...
  /* MDL_BACKUP_STMT */
  MDL_BIT(MDL_BACKUP_STAGE3) | MDL_BIT(MDL_BACKUP_STAGE4) | MDL_BIT(MDL_BACKUP_FTWRL1) | MDL_BIT(MDL_BACKUP_FTWRL2),
  MDL_BIT(MDL_BACKUP_FTWRL1) | MDL_BIT(MDL_BACKUP_FTWRL2),
  /* MDL_BACKUP_COMMIT */
